                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"  style={{"text-align": "center"}}>
                                        <div class="breadcomb-wp">
                                            <div class="breadcomb-icon">
                                                <i class="icon nalika-analytics"></i>
                                            </div>
                                            <div class="breadcomb-ctn">
                                                <h2>Selamat Datang Admin</h2>
                                                <p>Welcome to <span class="bread-ntd">Dashboard</span></p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase">
                                    <a href="list_soal_pembahasan.html">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="Laporan_transaksi.html">View Report</a>
                            </div>
                            <table>
                                <tr>
                                    <th>No.</th>
                                ...
                                <tr>
                                    ...
                                    <td>Rp.100.000</td>
                                    <td>
                                        <button class="ds-setting">NonAktif</button>
                                    </td>
                                    <td>
                                        <a href="edit_transaksi.html" class="btn btn-primary">Edit</a>
                                        <a href="remove.html" class="btn btn-danger">Remove</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                ...
                                <tr>
                                    ...
                                    <td>Rp.100.000</td>
                                    <td>
                                        <button class="ds-setting">Non Aktif</button>
                                    </td>
                                    <td>
                                        <a href="edit_transaksi.html" class="btn btn-primary">Edit</a>
                                        <a href="remove.html" class="btn btn-danger">Remove</a>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>male</td>
                                    <td>082466668889</td>
                                    <td>Jakarta utara, pluit</td>
                                    <td>pass</td>
                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"
                                            style={{"margin-bottom":"20px"}}>
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            <a href="edit_admin.html"> Edit</a>
                                        </button>
