        ...
        <div class="container-fluid Pengumuman" id="sectionblog">
            ...
            <div class="row justify-content-center">
                <div class="col-lg text-center">
                    ...
                    <img src="img/p1.jpg" class="img-fluid" alt="Pengumuman" />
                    <h4>Note</h4>
                    <p>
                ...
                <div class="col-lg">
                    ...
                    <div class="media">
                        <img class="mr-3" src="./img/m1.jpg" alt="Generic placeholder image" />
                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <a class="pr-3" href="#">
                                    <img src="./img/m2.jpg" alt="Generic placeholder image" />
                                </a>
                                <div class="media-body">
